...
namespace BrightstarDB.Samples.EntityFramework.Foaf 
{
    ...
    public partial class Person : BrightstarEntityObject, IPerson 
    {
    	...
    	public System.Collections.Generic.ICollection<System.String> Emails
    	{
    		get { return GetRelatedLiteralPropertiesCollection<System.String>("Emails"); }
    		set { if (value == null) throw new ArgumentNullException("value"); SetRelatedLiteralPropertiesCollection<System.String>("Emails", value); }
    	}
    	#endregion
    }
}
